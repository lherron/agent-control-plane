...
export function renderServerHelp(): string {
  return [
    ...
    '  --wrkq-db <locator>       Local path or rpc:// locator; defaults to ACP_WRKQ_DB or WRKQ_DB',
    '  --wrkq-db-path <path>     Legacy path-only input; defaults to ACP_WRKQ_DB_PATH or WRKQ_DB_PATH',
    ...
    '',
    'Environment:',
    '  ACP_WRKQ_DB / WRKQ_DB    Canonical wrkq local path or rpc:// locator',
    '  ACP_WRKQ_DB_PATH / WRKQ_DB_PATH Legacy path-only compatibility inputs',
